...
public class MapSetting : MonoBehaviour
{
            ...
            if (trafficLanes[i].StopLine != null)
            {
                ...
                if (stopLine.TrafficLight != null)
                {
                    ...
                    if (laneletID != null)
                    {
                        ...
                        if (laneletID.relationID.Count > 0)
                        {
                            lane.trafficlightsRelationID = laneletID.relationID;
                            Debug.Log("done Some thing special");
                        }
                    }
                }
            }
    ...
    public class Lane
    {
        ...
        public List<long> trafficlightsRelationID;
        ...
        public Lane(string name)
        {
            ...
            this.trafficlightsRelationID = new List<long>();
        }
