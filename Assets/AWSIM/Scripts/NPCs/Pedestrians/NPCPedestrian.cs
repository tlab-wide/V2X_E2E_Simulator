...
namespace AWSIM
{
    ...
    public class NPCPedestrian : MonoBehaviour, ISpeed
    ...
    [Header("Ground follow parameters")] [SerializeField, Tooltip("Ray-cast max distance for locating the ground.")]
    private float rayCastMaxDistance = 100f;

    [SerializeField,
     Tooltip("Upward offset of the ray-cast origin from the GameObject local origin for locating the ground.")]
